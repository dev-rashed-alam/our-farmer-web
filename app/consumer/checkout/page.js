                                    ...
                                    <Col>
                                        <FormGroup>
                                            ...
                                            <Form.Control type="text" placeholder="First Name"
                                                          className="checkout-input" id='first_name' required
                        ...
                        <Col xs={4} className="bg-body-tertiary p-3 place-order">
                            ...
                            <Row className="border-bottom p-3">
                                ...
                                <Col xs={4}>
                                    <div>
                                        <span
                                            className="fw-bold">Tk {delivery + totalPrice - (totalPrice - subTotal)}</span>
                                    </div>
                                </Col>
                            </Row>
                            <Row className="border-bottom p-3">
                            ...
                            <Row className="border-bottom p-3">
                                <Col xs={12}>
                                    <span className="text-body-secondary small">Your personal data will be used to process your order,support your experience throughout this website, and forother purposes described in our <Link
                            ...
                            <Row className="border-bottom p-3">
                                <Col xs={12}>
                                    <FormCheck type="checkbox" name="agree" id="agree"
                                               label="I have read and agree to the website terms and conditions."/>
                                    {
                                        !inputData.agree &&
                                        <FormText className="text-danger">Please agree to the terms and
                                            conditions</FormText>
                                    }
                                </Col>
                            </Row>
                            ...
                            <Row>
                                <Col>
                                    <Button className="checkout-button" onClick={() => handlePlaceOrder()}>Place
                                        Order</Button>
                                </Col>
                            </Row>
                        </Col>
